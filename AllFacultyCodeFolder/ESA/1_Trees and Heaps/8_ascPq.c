...
int main()
{
	...
	topDownHeap(h,n);
	printf("Top down Min heap constructed. Elements are enqueued\n");
	for(int i=0;i<n;i++)
		printf("%d ",h[i]);
...
int minDelete(int h[],int *n)	//dequeue
{
	int delEle=h[0];
	h[0]=h[*n-1];
